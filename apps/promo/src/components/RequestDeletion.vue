    ...
    <nav class="fixed top-0 left-0 right-0 z-50 px-4 sm:px-6 py-4 bg-black/30 backdrop-blur-md border-b border-white/5">
      <div class="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div class="flex items-center space-x-3">
          ...
          <a href="/privacy-policy" class="text-white/70 hover:text-white text-sm transition hidden sm:block">Privacy Policy</a>
        </div>
      </div>
    </nav>
      ...
      <div class="max-w-lg mx-auto">
        ...
        <div v-else class="animate-fadeinup bg-white/10 backdrop-blur-sm border border-white/10 rounded-2xl p-6 sm:p-8">
          ...
          <p class="text-center text-white/30 text-xs mt-5">
            ...
            <a href="/login" class="text-emerald-400 underline hover:text-emerald-300 transition">Sign in to delete instantly →</a>
          </p>
        </div>
...
const API_BASE = '/api/v1';  // same-origin (served by the echobit Worker)
